...
public class StoreTestProgram {
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println("Couldn't use file");
        }
...
//            objOut = new ObjectOutputStream(new FileOutputStream("store.txt"));
...
//            objIn = new ObjectInputStream(new FileInputStream("store.txt"));
